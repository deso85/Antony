...
public class ChangelogCmd extends ServerCommand {
	...
	private List<ChangeLogEntry> getChangeLog(int limit) {
        ...
        changeLog.add(new ChangeLogEntry("18.09.2025 - Version 7.17.0", "Die Befehle ***Softban*** und ***Serverstats*** wurden auf das neue Berechtigungsmodell umgestellt. Zudem wurde die Hilfe-Ausgabe verbessert, sodass Überschrift und Footer nicht mehr mehrfach erscheinen."));
